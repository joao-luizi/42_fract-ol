...
/*   Updated: 2024/11/19 17:57:43 by joaomigu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @brief Converts a string to a floating-point number,
	with error handling for invalid formats.
 *
 * @param str Input string to convert.

	* @param error Pointer to the error flag (set to TRUE 
	if the string is not a valid floating-point number).

	* @return double The converted floating-point number 
	(or 0.0 if an error occurred).
 */
